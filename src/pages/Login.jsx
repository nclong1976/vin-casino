...
export default function Login() {
  ...
  const { requireOtpVerification, markOtpVerified } = useAuth();
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (loginSuccess) {
        // Mật khẩu đã đúng nên Supabase đã tạo session thật (isAuthenticated
        // sắp bật) - PHẢI đánh dấu otpPending NGAY ở đây để App.jsx tiếp tục
        // giữ người dùng ở luồng đăng nhập cho tới khi qua được bước OTP bên
        // dưới, thay vì cho vào thẳng Trang chủ.
  ...
  const handleOtpSubmit = async (e) => {
    ...
    // Gỡ cờ chặn NGAY khi mã đúng - từ giờ App.jsx mới thực sự coi là đăng
    // nhập xong và cho vào app.
    markOtpVerified();
