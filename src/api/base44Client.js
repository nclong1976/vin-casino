...
const seedData = {
  Project: [
    ...
    {
      id: 'p_vinfast_mobility',
      title: 'VinFast Green Mobility Fleet',
      name: 'VinFast Green Mobility Fleet',
      category: 'Dự Án',
      location: 'Toàn Quốc',
      image: 'https://images.unsplash.com/photo-1563720223185-11003d516935?w=600&h=400&fit=crop',
      price_per_m2: 15000000,
      priceStr: '100 triệu',
      rate: '0.05%/phút',
      annual_yield: 0.05,
      area: 'Tiêu chuẩn',
      ...
      minAmount: '100000000',
      duration: '60 phút',
      scale: 'Mở rộng 50.000 xe điện',
      is_active: true,
      description: 'Quỹ tài trợ phát triển hạ tầng xe điện xanh và mở rộng mạng lưới giao thông thông minh, sinh lời liên tục theo phút.'
    },
    {
      id: 'p_vincom_megamall',
      title: 'Vincom Retail Megamall Expansion',
      name: 'Vincom Retail Megamall Expansion',
      category: 'Dự Án',
      location: 'Các Thành phố lớn',
      image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&h=400&fit=crop',
      price_per_m2: 30000000,
      priceStr: '500 triệu',
      rate: '0.04%/phút',
      annual_yield: 0.04,
      area: '100-300m²',
      ...
      minAmount: '500000000',
      duration: '120 phút',
      scale: 'Chuỗi 10 Megamall thế hệ mới',
      is_active: true,
      description: 'Phát triển và vận hành chuỗi trung tâm thương mại cao cấp Vincom Mega Mall toàn quốc, chia sẻ lợi nhuận tính theo phút.'
    },
    {
      id: 'p_vinclub_internal_fund',
      title: 'Quỹ Đầu Tư Sinh Lời Nội Bộ VinClub',
      name: 'Quỹ Đầu Tư Sinh Lời Nội Bộ VinClub',
      category: 'Dự Án',
      location: 'Hệ sinh thái VinClub',
      image: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=600&h=400&fit=crop',
      price_per_m2: 1000000,
      priceStr: '1.000.000 ₫/Suất',
      rate: '0.02%/phút',
      annual_yield: 0.02,
      area: '1 Suất tích sản',
      progress: 99,
      minAmount: '1000000',
      duration: '30 phút',
      scale: 'Quỹ tích sản nội bộ VinClub',
      is_active: true,
      description: 'Gói đầu tư sinh lời nội bộ quy mô nhỏ dành riêng cho thành viên VinClub, nhận lãi sinh lời cộng dồn hằng phút vào ví.'
    },
    {
      id: 'p_vinclub_startup_fund',
      title: 'Quỹ Khởi Nghiệp & Chuỗi Nhượng Quyền VinClub',
      name: 'Quỹ Khởi Nghiệp & Chuỗi Nhượng Quyền VinClub',
      category: 'Dự Án',
      location: 'Toàn quốc',
      image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=600&h=400&fit=crop',
      price_per_m2: 10000000,
      priceStr: '10.000.000 ₫/Suất',
      rate: '0.06%/phút',
      annual_yield: 0.06,
      area: '1 Suất góp vốn',
      progress: 82,
      minAmount: '10000000',
      duration: '180 phút',
      scale: 'Chuỗi 100 dự án vừa & nhỏ',
      is_active: true,
      description: 'Tài trợ vốn phát triển các dự án khởi nghiệp nhỏ, chuỗi dịch vụ tiện ích và giải pháp công nghệ nội bộ VinClub, lãi chi trả theo phút.'
    },
    {
      id: 'p_stock_vic',
