...
export default function NotificationsTab() {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      ...
      // Thông báo gắn với 1 dự án cụ thể (kèm snapshot số liệu tại thời
      // điểm gửi) giờ soạn & gửi trực tiếp từ thẻ dự án trong tab "Dự án"
      // (xem ProjectNotifyModal trong ProjectsTab.jsx) - form chung ở đây
      // chỉ còn phát broadcast không gắn số liệu 1 dự án cụ thể nào.
      let targetLabel = "";
      let created;
          ...
          >
            ...
            >
              ...
              <div className="p-5 overflow-y-auto space-y-4 flex-1">
                ...
                {/* Thông báo gắn với 1 dự án cụ thể (tự điền số liệu, kèm
                    snapshot dự án) giờ soạn trực tiếp từ thẻ dự án trong tab
                    "Dự án" - xem ProjectNotifyModal (ProjectsTab.jsx). Chọn
                    loại "Đầu tư & Dự án" ở đây vẫn dùng được cho thông báo
                    broadcast chung không gắn số liệu 1 dự án cụ thể nào. */}
